import { require_react_dom } from './chunk-NOSD3EBE.js';
import { __commonJS, __toESM, require_react } from './chunk-G4V7ITBN.js';
...
function RouterProvider({
  ...
  }, [pendingState, renderDfd, router2.window, unstable_useTransitions, setOptimisticState]);
  React3.useEffect(() => {
...
try {
  if (isBrowser2) {
    window.__reactRouterVersion = '7.13.0'; // @ts-expect-error
  }
} catch (e) {}
