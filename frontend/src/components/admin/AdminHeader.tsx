...
const AdminHeader: React.FC<Props> = ({ onMenuClick, showMenuBtn = false }) => {
      ...
      <div className="flex items-center justify-between h-16 px-4 md:px-8">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <div ref={ddRef} className="relative">
            ...
            >
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-purple-400/30 to-pink-600/30 flex items-center justify-center text-[11px] font-bold text-purple-400 border border-purple-400/10">
                AD
              </div>
            ...
            {ddOpen && (
              <div className="absolute right-0 top-[calc(100%+8px)] w-56 bg-[#0f1629] border border-white/[0.08] rounded-xl shadow-[0_16px_48px_rgba(0,0,0,0.5)] overflow-hidden animate-[fadeSlideDown_0.2s_ease-out]">
                <div className="px-4 py-3 border-b border-white/[0.06]">
                  ...
                  <p className="text-[11px] text-slate-500 mt-0.5 font-mono">0x9abc...def0</p>
                </div>
